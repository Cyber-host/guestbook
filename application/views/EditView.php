<div class="wrapper_main_body">
	<div class="wrapper_form_inputs">
		<form action="/guestbook/main/editwrite/" method="POST">
			...
			<div class="wrapper_input_name"><input class="input_name" type="text" name="name_user" value="<?php echo $pData['name']; ?>" /></div>
			<div class="wrapper_input_text"><textarea maxlength="500" class="input_text_user" name="text_user"><?php echo $pData['long_text']; ?></textarea></div>
		...
		<div class="foot_message" style="border: 0;">
			<div class="foot_message_menu">date last edit: <?php echo $pData['datechange']; ?></div>
